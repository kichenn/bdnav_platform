 ...
 */
@RestController
@RequestMapping("/clientSchoolUserWeb")
@Validated
@Slf4j
@Api(value = "学校管理员--学校用户交互API", tags = "学校管理员--学校用户交互交互API")
public class SchoolUserWebController {
    ...
    @ApiOperation(value = "当前学校用户信息列表数据[分页筛选]", response = SchoolRole.class)
    ...
    @ApiOperation(value = "添加学校用户信息（需学校admin权限）", response = Boolean.class)
    public Object addSchoolUser(@Validated @RequestBody AddSchoolUserDto addUserDto) {
        ...
        addUserDto.setSchoolCode(user.getSchoolCode());
        addUserDto.setSchoolId(user.getSchoolId());
    ...
    @ApiOperation(value = "修改学校用户信息（需学校admin权限）", response = Boolean.class)
    ...
    @ApiOperation(value = "根据id删除学校用户信息（需学校admin权限）", response = Boolean.class)
    ...
    @ApiOperation(value = "批量删除学校用户信息（需学校admin权限）", response = Boolean.class)
    ...
    @ApiOperation(value = "修改用户状态(启用或者禁用)（需学校admin权限）", response = Boolean.class)
